/*
    This was implemented with a collegue of mine in bachelor studies
      If i remember correctly then the rcon and sbox was taken from some source
      but i don't remember which one. The gmul() was taken from wiki. Other than that
      everything else was written by ourselves, atleast i think so.
*/
